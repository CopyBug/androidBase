...
import com.sx.widget.view.floatWIndow.floatingview.utils.EnContext;
...
public class FloatingView implements IFloatingView {
    ...
    private int mIconRes = R.drawable.ic_flow_car;
    ...
    private void ensureFloatingView() {
        synchronized (this) {
         ...
         EnFloatingView enFloatingView = new EnFloatingView(EnContext.get(), mLayoutId);
            enFloatingView.setActivity(activity);
    ...
    private FrameLayout.LayoutParams getParams() {
        ...
        params.setMargins(13, params.topMargin, params.rightMargin, 100);
        return params;
    }
