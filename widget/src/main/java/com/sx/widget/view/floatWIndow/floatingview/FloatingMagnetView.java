...
import com.sx.widget.view.floatWIndow.floatingview.utils.SystemUtils;
...
public class FloatingMagnetView extends FrameLayout {
    ...
    private void init() {
        ...
        setClickable(true);
        updateSize();
//        mDialog = new PortSelectDialog.Builder((FragmentActivity) getContext());
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(Math.abs(currentY-getY())<50&&Math.abs(currentX-getX())<50){
