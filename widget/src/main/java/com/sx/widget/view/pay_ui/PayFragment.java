package com.sx.widget.view.pay_ui;
...
public class PayFragment extends DialogFragment implements View.OnClickListener, PayPwdView.InputCallBack {
    ...
    private PayPwdView.ForgetCallBack forgetCallBack;

    private String type = "";
    private String money = "";
    public boolean passWordType= false;

    public void setPassWordType(boolean passWordType) {
        this.passWordType = passWordType;
    }

    public void setForgetCallBack( PayPwdView.ForgetCallBack forgetCallBack){
    ...
    private void initView(Dialog dialog) {
        ...
        if(passWordType){
            dialog.findViewById(R.id.pay_money).setVisibility(View.GONE);
            dialog.findViewById(R.id.type_tv).setVisibility(View.GONE);
        }
        dialog.findViewById(R.id.pay_forget).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.iv_close_rl) {
            dismiss();
        }else if(v.getId()==R.id.pay_forget){
            forgetCallBack.forget();
            dismiss();
            //忘记密码
        }
    }
